...
docker exec sistema54-db pg_dump -U admin -d sistema54_db > $backupFile
...
Write-Host "  docker exec -i sistema54-db psql -U admin -d sistema54_db < $backupFile" -ForegroundColor Cyan
